-- put this in autoexc for 60 unc functions will add on or replace some so delete the ones you already have (that is if they work)
-- 60/114 53% NOTE: u need to put queue_on_teleport in ur autoexec
...
getgenv().joingame = function(placeID, jobID)
    game:GetService("TeleportService"):TeleportToPlaceInstance(placeID, jobID, getplayer())
end
getgenv().joinserver = function(placeID, jobID)
    game:GetService("TeleportService"):TeleportToPlaceInstance(placeID, jobID, getplayer())
end
